...
python -m pip install numpy opencv-python requests python-dotenv --quiet
python -m pip install dlib-bin --quiet
python -m pip install --no-build-isolation face_recognition --quiet
...
python -c "import cv2, numpy, requests, dotenv, dlib, face_recognition; print('[OK] Core AI Face Engine verified! dlib version:', dlib.__version__)"
echo.
