  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] backdrop-blur-xl border border-white/15",
  {
    variants: {
      variant: {
        ...
        ios: "bg-gradient-ios-blue text-white shadow-lg shadow-ios-blue/40 hover:shadow-xl hover:shadow-ios-blue/50 hover:-translate-y-0.5 hover:scale-[1.01]",
        "ios-green": "bg-gradient-ios-green text-white shadow-lg shadow-ios-green/40 hover:shadow-xl hover:shadow-ios-green/50 hover:-translate-y-0.5 hover:scale-[1.01]",
        "ios-pink": "bg-gradient-ios-sunset text-white shadow-lg shadow-ios-pink/40 hover:shadow-xl hover:shadow-ios-pink/50 hover:-translate-y-0.5 hover:scale-[1.01]",
