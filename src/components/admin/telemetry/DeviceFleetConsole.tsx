                ...
                >
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[11px]">
                      ...
                      {timeOnRoute < 15000 ? (
                        <span className="inline-flex items-center gap-1 text-[10px] font-bold text-amber-500 bg-amber-500/10 px-1.5 py-0.5 rounded-md border border-amber-500/20 animate-pulse">
                          <Zap className="w-2.5 h-2.5" />
                          <span>Just Switched</span>
                        </span>
                      ) : (
                    ...
                    <div className="px-2.5 py-2 rounded-xl bg-primary/5 border border-primary/15 flex flex-col gap-1">
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-xs font-bold text-foreground truncate">
                          {session.pageTitle || getRouteDisplayName(session.currentRoute)}
                        </span>
