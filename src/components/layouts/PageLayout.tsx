...
const PageLayout: React.FC<PageLayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none will-change-transform" style={{ contain: 'strict' }} aria-hidden="true">
        <div 
          className="absolute top-16 left-8 w-72 md:w-[30rem] h-72 md:h-[30rem] rounded-full opacity-35 dark:opacity-20 pointer-events-none"
          style={{
        ...
        />
        <div 
          className="absolute bottom-20 right-8 w-80 md:w-[32rem] h-80 md:h-[32rem] rounded-full opacity-30 dark:opacity-15 pointer-events-none"
          style={{
        ...
        />
        <div 
          className="absolute top-1/3 right-1/4 w-80 md:w-[34rem] h-80 md:h-[34rem] rounded-full opacity-25 dark:opacity-15 pointer-events-none"
          style={{
