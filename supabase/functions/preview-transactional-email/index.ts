...
// Gated by SUPABASE_SERVICE_ROLE_KEY or API_SECRET.
...
Deno.serve(async (req) => {
  ...
  // Verify the caller is authorized with SUPABASE_SERVICE_ROLE_KEY or API_SECRET
